...
if __name__ == "__main__":
    ...
    project_prefix = f"data_floquet_afssh_E0_{E0}-Omega_{Omega}-N_{N}-phi_{phi}"
    NF = estimate_NF(A, Omega)  
    main(project_prefix=project_prefix, ntrajs=ntrajs, E0=E0, Omega=Omega, phi=phi, N=N, t0=t0, pulse_type=pulse_type, param_set=param_set, solver=NonadiabaticDynamicsMethods.AFSSH, basis_rep=BasisRepresentation.ADIABATIC, NF=NF, init_state=init_state)

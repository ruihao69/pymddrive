...
if __name__ == "__main__":
    ...
    project_prefix = "data_ehrenfest_adiabatic"
    init_state = 0
    dt = 0.003

    # test_sampling()
    main(project_prefix=project_prefix, ntrajs=ntrajs, solver=NonadiabaticDynamicsMethods.EHRENFEST, basis_rep=BasisRepresentation.ADIABATIC, init_state=init_state, integrator=NumericalIntegrators.RK4, dt=dt)

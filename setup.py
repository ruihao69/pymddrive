...
class CMakeExtension(Extension):
    def __init__(self, name: str, sourcedir: str = "", dest_dir: str='./') -> None:
...
class CMakeBuild(build_ext):
    def build_extension(self, ext: CMakeExtension) -> None:
        ...
        libfilename = ext_fullpath.name
        import shutil
        shutil.copy(ext_fullpath, dest_dir / libfilename)
        # dest_dir.mkdir(parents=True, exist_ok=True)
        # for file in build_temp.iterdir():
        #     if file.is_file():
...
setup(
    ...
    ext_modules=[
        CMakeExtension("_low_level", dest_dir='./pymddrive/low_level'),
    ],
